    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNav.setOnItemSelectedListener(item -> {
            ...
            if (itemId == R.id.nav_home) {
                ...
                startActivity(new Intent(BudgetTracker.this, TripActivity.class));
                overridePendingTransition(0, 0);
                finish();
                return true;
            } else if (itemId == R.id.nav_trip_history) {
                startActivity(new Intent(BudgetTracker.this, TripHistory.class));
                overridePendingTransition(0, 0);
                finish();
                return true;
            } else if (itemId == R.id.nav_user_profile) {
                startActivity(new Intent(BudgetTracker.this, UserProfile.class));
                overridePendingTransition(0, 0);
                finish();
                return true;
            }
